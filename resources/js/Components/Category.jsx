...
export default function Category({ category }) {
    ...
    const submit = (e) => {
        e.preventDefault();
        patch(route('categories.update', category.slug), {
                                ...
                                <Link
                                    onClick={() => {
                                        ask({
                                            ...
                                            method: 'delete',
                                            message:
                                                'Danger! Are you sure you want to delete this category? This action cannot be undone. please be sure you want to delete this category.',
                                        });
                                    }}
                                >
                                    <button
